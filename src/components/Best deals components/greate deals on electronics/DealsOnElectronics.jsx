...
export const DealsOnElectronics = () => {
  return (
    ...
    <div className={dealelect.eachitemcontainer}>
        <Link to={`/commonbestdeals/refrigerators`}>
        ...
        <Link to={`/commonbestdeals/bigscreentv`}>
        ...
        <Link to={`/commonbestdeals/storage`}>
        ...
        <Link to={`/commonbestdeals/appleaudoaccessories`}>
        ...
        <Link to={`/commonbestdeals/homeandkitchen`}>
        ...
        <Link to={`/commonbestdeals/jiophone`}>
        ...
        <Link to={`/commonbestdeals/boatsounders`}>
        ...
        <Link to={`/commonbestdeals/applewatch`}>
